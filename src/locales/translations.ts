...
const translations: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    dateMenuNotReady: 'Меню на эту дату ещё не готово',
    calendarMonthNotReady: 'На этот месяц меню пока не готово — попробуйте другой месяц или загляните позже',
    ...
    dayMenuRemoved: 'На эту дату меню убрали — уберите день, чтобы оформить заказ',
    ...
    // Управление меню — переехало в lunchistan-core вместе с OwnerView (21.09.2026)
    ...
    ownerMovedToCore: 'Этот раздел — для сотрудников и клиентов. Управление бизнесом теперь в Lunchistan Core.',
    ...
    employeesEmpty: 'В команде пока никого нет.',
    employeesEmptyHow: 'Отправьте сотрудникам код {code} — при регистрации они выбирают «У меня есть код команды» и вводят его. После этого сотрудник появится здесь, с кнопками «Сбросить пароль» и «Уволить».',
    resetPasswordBtn: 'Сбросить пароль',
    deleteEmployeeBtn: 'Уволить',
    deleteEmployeeConfirm: 'Убрать {name} из команды? Доступ в приложение пропадёт.',
    newPasswordTitle: 'Новый пароль сотрудника',
    newPasswordHint: 'Сообщите этот пароль сотруднику лично — он показывается только один раз',
    ...
    confirmSuccessNoTelegram: 'Заказ на день подтверждён, но чек в Telegram не ушёл — нажмите «Отправить чек ещё раз».',
    ...
    retry: 'Повторить',
    repeatOrderBtn: 'Повторить заказ',
    repeatOrderNoDates: 'Пока нет дат с меню — повторить заказ можно, когда кухня назначит меню.',
  ...
  uz: {
    ...
    dateMenuNotReady: "Bu sanaga menyu hali tayyor emas",
    calendarMonthNotReady: "Bu oy uchun menyu hali tayyor emas — boshqa oyni tanlang yoki keyinroq qaytib keling",
    ...
    dayMenuRemoved: 'Bu sanadan menyu olib tashlandi — buyurtma berish uchun kunni olib tashlang',
    removeDay: 'Kunni olib tashlash',
    ...
    // Menyuni boshqarish — lunchistan-core'ga OwnerView bilan birga ko'chdi (21.09.2026)
    ...
    ownerMovedToCore: "Bu bo'lim — xodimlar va mijozlar uchun. Biznesni boshqarish endi Lunchistan Core'da.",
    ...
    availableSets: "Mavjud taomlar: {n}",
    ...
    employeesEmpty: 'Jamoada hali hech kim yo\'q.',
    employeesEmptyHow: "Xodimlarga {code} kodini yuboring — ro'yxatdan o'tishda «Jamoa kodim bor»ni tanlab, kodni kiritadi. Shundan so'ng xodim shu yerda «Parolni tiklash» va «Ishdan bo'shatish» tugmalari bilan paydo bo'ladi.",
    resetPasswordBtn: 'Parolni tiklash',
    deleteEmployeeBtn: 'Ishdan bo\'shatish',
    deleteEmployeeConfirm: '{name} jamoadan chiqarilsinmi? Ilovaga kirish imkoniyati yo\'qoladi.',
    newPasswordTitle: 'Xodimning yangi paroli',
    newPasswordHint: 'Bu parolni xodimga shaxsan ayting — u faqat bir marta ko\'rsatiladi',
    waiting: 'Odatda',
    ...
    confirmSuccessNoTelegram: "Kun buyurtmasi tasdiqlandi, lekin chek Telegram-ga yuborilmadi — «Chekni qayta yuborish» tugmasini bosing.",
    ...
    retry: "Qayta urinish",
    repeatOrderBtn: 'Buyurtmani takrorlash',
    repeatOrderNoDates: "Hozircha menyuli sanalar yo'q — oshxona menyu belgilaganda buyurtmani takrorlash mumkin.",
