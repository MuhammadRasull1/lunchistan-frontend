...
const translations: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    // 🆆 17.09.2026: Меню по датам — блюда бизнеса не повторяются день в день,
    // владелец сам отмечает, какие блюда каталога предложены на конкретную дату.
    dailyMenuManage: 'Меню по датам',
    dailyMenuTitle: 'Меню на дату',
    dailyMenuHint: 'Отметьте блюда, которые предлагаются клиентам в этот день. Без отметки дата недоступна для заказа.',
    dailyMenuDateLabel: 'Дата',
  ...
  uz: {
    ...
    dailyMenuManage: 'Sanalar bo\'yicha menyu',
    dailyMenuTitle: 'Sana uchun menyu',
    dailyMenuHint: "Shu kuni mijozlarga taklif qilinadigan taomlarni belgilang. Belgilanmasa, sana buyurtma uchun mavjud bo'lmaydi.",
    dailyMenuDateLabel: 'Sana',
