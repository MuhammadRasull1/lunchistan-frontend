...
export interface CartItem {
  ...
  salad: Salad;
  /**
   * Выбранное клиентом блюдо (id сета из текущего меню) — «токен» дня.
...
export interface SelectedDay {
   ...
   * иначе первое блюдо дневного меню этой даты (App.tsx, dayMenus[date]) как
   * визуальный плейсхолдер, пока не выбрано (или не назначено само — см. `chosen`).
   */
  set: LunchSet;
