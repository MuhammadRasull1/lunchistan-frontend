...
- **Hero-изображение** — `<img>` с `object-fit: cover`, picsum.photos (Unsplash) на 160px, `loading="lazy"`, fallback на градиент при ошибке
...
- **Изображение блюда** — `<img>` 140×140px с `object-fit: cover`, picsum.photos, градиентный фон-резерв
