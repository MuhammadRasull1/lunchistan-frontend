...
- **Hero-изображение** — `<img>` с `object-fit: cover`, локальный SVG/AI-файл `/images/sets/day-N.svg`, `loading="lazy"`, fallback на градиент при ошибке
...
- **Изображение блюда** — `<img>` 140×140px с `object-fit: cover`, локальный SVG/AI `/images/sets/day-N.svg`, градиентный фон-резерв
