...
- **Пресет «Вся рабочая неделя»**: кнопка `CalendarPlus` у каждой строки недели выбирает **Пн–Сб** именно той недели (6-дневная рабочая неделя UZ, вс — выходной; повторное нажатие снимает).
